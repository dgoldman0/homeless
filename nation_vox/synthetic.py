...
essay_prompts = {
    ...
    "Describe a world where every promise must come true.": [
        "What separates a promise from a mere statement?",
        "How do societies determine when words carry obligation?",
        "What makes a commitment trustworthy?",
        "How does intent factor into moral responsibility?",
        "Can consent be valid if consequences aren’t understood?",
        "How do different cultures define verbal honor?",
        "What safeguards exist to prevent manipulation through language?",
        "What is the role of ambiguity in communication?",
        "How do people learn which words have consequences?",
        "Can trust exist without the possibility of betrayal?",
        "What is the difference between a lie and a broken promise?",
        "How does language create binding relationships?",
        "What are the social functions of vows, oaths, or pledges?",
        "Can accountability exist without enforcement?",
        "What psychological effect does promise-keeping have on identity?",
        "How do social contracts form through speech?",
        "How does repetition create ritual or meaning in language?",
        "Is it ethical to hold someone to a promise made under pressure?",
        "What is the difference between being honest and being bound?",
        "How does fear of consequence alter the way people speak?",
        "What happens when silence is more truthful than speech?",
        "How do people use words to gain power over others?",
        "Can intentions shift after a promise is made?",
        "What are the consequences of binding speech in legal systems?",
        "How do religious traditions treat the sanctity of speech?",
        "What’s the relationship between speech and personal agency?",
        "How does early childhood experience affect understanding of promises?",
        "What are the dangers of making absolute statements?",
        "How do people navigate conflicting obligations?",
        "Is it possible to create ethical rules for speech?",
        "What does it mean to be held accountable for one’s words?",
        "How do rituals formalize speech into action?",
        "Can a promise exist without social recognition?",
        "How does language reflect or construct moral systems?",
        "How do people make peace with past commitments?",
        "Can silence be weaponized as a form of promise refusal?",
        "What makes a promise credible in the eyes of others?",
        "How do non-verbal cultures express binding commitments?",
        "What is the relationship between public promises and social trust?",
        "How do emotions like guilt and shame regulate promise-keeping?",
        "Can someone act ethically while breaking a promise?",
        "What kind of legal systems emerge from verbal cultures?",
        "What role does memory play in enforcing agreements?",
        "How does collective memory hold leaders accountable?",
        "What defines a promise in the absence of written language?",
        "Can promises evolve across generations?",
        "How do we balance freedom of speech with consequences of speech?",
        "What is the role of language in creating shared futures?",
        "How do people protect themselves from being coerced into promises?",
        "What distinguishes personal responsibility from communal enforcement?"
    ],
